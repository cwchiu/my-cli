...
- Taskfile targets: `build`, `run`, `test`, `vet`, `fmt`, `lint`, `tidy`, `security:*`, `clean`.
...
- Test suite covering exit-code mapping, configuration loading, and version output
  (85.9% statement coverage, floor 85%).
